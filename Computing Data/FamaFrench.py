...
ff_data_w = pd.read_excel(filepath, index_col=0,
                          engine=None, sheet_name="Weekly")
...
for i in range(len(finaldata)):
    filepath = directory+"/SavedData/Frenched/"+tickers[i]+"Ratios.xlsx"
    save_xls(finaldata[i], finaltickers[i], filepath)

for i in range(len(finaldata)):
    filepath = directory+"/SavedData/Frenched/"+tickers[i]+"Raw.xlsx"
