...
column_list = ['Days to Expiration','Ticker Symbol','The Date of this Option Price']

data['The Date of this Option Price']= pd.to_datetime(data['The Date of this Option Price'])
data['The Date of this Option Price']= data['The Date of this Option Price'].dt.strftime('%Y-%m-%d')
...
midvolcomp = pd.DataFrame(index=midvol['The Date of this Option Price'].unique())
